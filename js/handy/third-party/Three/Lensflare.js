...
var Lensflaree = function () {

	Mesh.call( this, Lensflaree.Geometry, new MeshBasicMaterial( { opacity: 0, transparent: true } ) );

	this.type = 'Lensflaree';
	...
	var geometry = Lensflaree.Geometry;
...
Lensflaree.prototype = Object.create( Mesh.prototype );
Lensflaree.prototype.constructor = Lensflaree;
Lensflaree.prototype.isLensflare = true;
...
export { Lensflaree, LensflareElement };
